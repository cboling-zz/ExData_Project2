...
Below is a description of the Project assignment. Source data is available from the ./data
subdirectory.  he R scripts and resulting plots are located in the base working director.
